...
//pictures
import carpenterpic1 from "../assets/carpenterpic1.jpg";
      ...
      <Box className={classes.whitebg}>
        <Box className={classes.topsection}>
          ...
          <Typography variant="h5">
            We provide quick Carpenter services
          </Typography>
        ...
        <Box className={classes.demo1}>
          ...
          <CardActionArea className={classes.demo1imgbox}>
            <img src={carpenterpic1} alt="carpenterpic1" width="100%" height="100%" style={{borderRadius:"10px"}}/>
          </CardActionArea>
        ...
        <CardActionArea className={classes.demo2imgbox}>
            <img src={carpenterpic2} alt="carpenterpic2" width="100%" height="100%" style={{borderRadius:"10px"}}/>
          </CardActionArea>
...
export default Carpentersubcategray;
