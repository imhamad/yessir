...
//pictures
import cleaningpic1 from "../assets/cleaningpic1.jpg";
import cleaningpic2 from "../assets/cleaningpic2.jpg";
    ...
    <>
      ...
      <Box className={classes.whitebg}>
        <Box className={classes.topsection}>
          ...
          <Typography variant="h5">We provide Cleaning services</Typography>
        ...
        <Box className={classes.demo1}>
          <Box className={classes.demo1description}>
            ...
            If you need someone, reliable, to help clean your home and take care of household chores. Make sure you are hiring the right person to take care of your needs.
           The first thing you want to do is make out a list of what service you need. Your list could include household chores such as:
          Laundry,	Vacuuming, Dusting, Making Beds, Doing Dishes, Preparing Meals, Taking Care of Basic Household Maintenance
          The type of tasks you select will determine whether you need a housekeeper or a maid. We are here to assist you about the type of job tasks and functions you need.
          We offer our services on hourly, daily, weekly, and monthly basis with flexible schedule. We provide trusted and registered workforce for the service as we are aware of the sensitivity of your concerns. Place an order and talk to us about the availability. 
                  
            </Typography>
          </Box>
          <CardActionArea className={classes.demo1imgbox}>
            <img src={cleaningpic1} alt="cleaningpic1" width="100%" height="100%" style={{borderRadius:"10px"}}/>
          </CardActionArea>
        ...
        <CardActionArea className={classes.demo2imgbox}>
            <img src={cleaningpic2} alt="cleaningpic2" width="100%" height="100%" style={{borderRadius:"10px"}}/>
          </CardActionArea>
...
export default Cleaningsubcategray;
