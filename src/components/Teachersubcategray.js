...
//pictures
import tutorpic2 from "../assets/tutorpic2.jpg";
// import tutorpic2 from "../assets/tutorpic2.jpg";
    ...
    <>
       <Box className={classes.whitebg}>
        <Box className={classes.topsection}>
          ...
          <Typography variant="h5">We provide best teaching services</Typography>
        ...
        <Box className={classes.demo1}>
          <Box className={classes.demo1description}>
            ...
            Teachers are the most respectful people of our society. Teachers are the backbone of any social progress. Effective teachers are able to plainly define students learning outcomes and offer an encouraging road map on how to achieve those outcomes. Select confidently from our list of teachers and leave the rest to us. We are fortunate to have a list of professional teachers both male and female who can teach ONLINE/ON campus. We have the facility


            </Typography>
          </Box>
          <CardActionArea className={classes.demo1imgbox}>
            <img src={tutorpic2} alt="tutorpic2" width="100%" height="100%" style={{borderRadius:"10px"}} />
          </CardActionArea>
        ...
        {/* //extra box start here// */}
        <Box style={{width:"100px",height:"100px",background:"red"}}>
        <Button size="small" 
             href="https://play.google.com/store/apps?utm_source=apac_med&utm_medium=hasem&utm_content=Jun0122&utm_campaign=Evergreen&pcampaignid=MKT-EDR-apac-pk-1003227-med-hasem-ap-Evergreen-Jun0122-Text_Search_BKWS-BKWS%7cONSEM_kwid_43700071429424196_creativeid_600975598452_device_c&gclid=Cj0KCQjw166aBhDEARIsAMEyZh4m8C3MRSsex1O8_8XZcCySCVJXv8kPScIe_7X-f6T80oXBaQrzB3IaAuvkEALw_wcB&gclsrc=aw.ds"
              title="instagram"
              aria-label="add"
...
export default Teachersubcategray;
