...
//pictures
import demo1pic from "../assets/demo1pic.png";
import demo2pic from "../assets/demo2pic.png";
//ac cardspic
    ...
    <>
      <Box className={classes.whitebg}>
        <Box className={classes.topsection}>
          <Typography variant="h5">We provide quick AC services</Typography>
        ...
        <Box className={classes.ACsubservicescardsection}>
          <Box className={classes.acsubcardsbox}>
            ...
            <Card variant="outlined" className={classes.acsubcard}>
              ...
              <Box className={classes.acsubcardtypographes}>
                <Typography variant="h6">AC Mounting & Dismounting</Typography>
                <Typography variant="h5">starting from: Rs 1500</Typography>
              </Box>
            </Card>
          </Box>
        ...
        <Box className={classes.demo1}>
          <Box className={classes.demo1description}>
            ...
            We offer AC installations, repair, and all related services. We have professionals who will do their jobs according to your satisfaction
            </Typography>
          </Box>
