...
//pictures
import electricianpic1 from "../assets/electricianpic1.jpg";
import electricianpic2 from "../assets/electricianpic2.jpg";
    ...
    <>
      <Box className={classes.whitebg}>
        <Box className={classes.topsection}>
          ...
          <Typography variant="h5">We provide Electrician services</Typography>
            ...
            <Card variant="outlined" className={classes.acsubcard}>
              ...
              <Box className={classes.acsubcardtypographes}>
                ...
                <NavLink
                    ...
                    exact
                  >
                    LED TV mounting or installation
                  </NavLink>
                </Typography>
                <Typography variant="h5">starting from: Rs 1500</Typography>
              </Box>
            ...
            <Card variant="outlined" className={classes.acsubcard}>
              ...
              <Box className={classes.acsubcardtypographes}>
                ...
                <NavLink
                    ...
                    exact
                  >
                    Switch board socket or button replacement
                  </NavLink>
                </Typography>
                <Typography variant="h5">starting from: Rs 1500</Typography>
              </Box>
        ...
        <Box className={classes.demo1}>
          <Box className={classes.demo1description}>
            ...
            Live hassle free life wherever and whenever.  If you need to install, maintain, repair electrical power, communications, lighting, and control systems then you are in the right place.
            We offer services almost all electrical works full time. Work schedules may include evenings and weekends. Overtime is common. Place your order and one of our electricians will serve you to the maximum of your satisfaction.

            </Typography>
          </Box>
          <CardActionArea className={classes.demo1imgbox}>
            <img src={electricianpic1} alt="electricianpic1" width="100%" height="100%" style={{borderRadius:"10px"}} />
          </CardActionArea>
        ...
        <CardActionArea className={classes.demo2imgbox}>
            <img src={electricianpic2} alt="electricianpic2" width="100%" height="100%" style={{borderRadius:"10px"}}/>
          </CardActionArea>
...
export default Electriciansubcategray;
