...
import plumbingpic2 from "../assets/plumbingpic2.jpg";
    ...
    <>
      <Box className={classes.whitebg}>
        <Box className={classes.topsection}>
          ...
          <Typography variant="h5">We provide Plumber services</Typography>
              ...
              <Box className={classes.acsubcardtypographes}>
                <Typography variant="h6">
                  <NavLink
                    ...
                    exact
                  >
                    Water geyser Installation and Repairing
                  </NavLink>
                </Typography>
            ...
            <Card variant="outlined" className={classes.acsubcard}>
              ...
              <Box className={classes.acsubcardtypographes}>
                ...
                <NavLink
                  ...
                  exact
                >
                 Washroom Accessory A Installation
            ...
            <Card variant="outlined" className={classes.acsubcard}>
              ...
              <Box className={classes.acsubcardtypographes}>
                ...
                <NavLink
                  ...
                  exact
                >
                 Water Leakage in Kitchen and Washroom
            ...
            <Card variant="outlined" className={classes.acsubcard}>
              ...
              <Box className={classes.acsubcardtypographes}>
                ...
                <NavLink
                  ...
                  exact
                >
                Flash Button and Lever Repairing
        ...
        <Box className={classes.demo1}>
          <Box className={classes.demo1description}>
            ...
            We have specialised plumbers who maintain the flow and drainage of potable (drinking) water by assembling, installing, and repairing pipes, fittings, and drainage in your office/home. We provide all types of services related to public health. Feel relaxed to fix all your plumbing issues by just choosing the most suitable day and time. 
            </Typography>
          </Box>
          <CardActionArea className={classes.demo1imgbox}>
            <img src={plumbingpic1} alt="plumbingpic1" width="100%" height="100%" style={{borderRadius:"10px"}} />
          </CardActionArea>
        ...
        <CardActionArea className={classes.demo2imgbox}>
            <img src={plumbingpic2} alt="plumbingpic2" width="100%" height="100%" style={{borderRadius:"10px"}} />
          </CardActionArea>
...
export default Plumbersubcategray;
