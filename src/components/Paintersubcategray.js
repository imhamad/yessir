...
//pictures
import painterpic1 from "../assets/painterpic1.jpg";
import painterpic2 from "../assets/painterpic2.jpg";
//ac cardspic
    ...
    <>
      <Box className={classes.whitebg}>
        <Box className={classes.topsection}>
          ...
          <Typography variant="h5">We also provide Painter services</Typography>
        ...
        <Box className={classes.ACsubservicescardsection}>
          ...
          <Box className={classes.acsubcardsbox}>
            ...
            {/* <Card variant="outlined" className={classes.acsubcard}>
              ...
              <Typography variant="h6">Despenser Fixing</Typography>
              <Typography variant="h5">starting from: Rs 1500</Typography>
              </Box>
            </Card>
            <Card variant="outlined" className={classes.acsubcard}>
        ...
        <Box className={classes.demo1}>
          <Box className={classes.demo1description}>
            ...
            Paint your walls, ceilings, and any part of your house/ office from a professional painter with full satisfaction of quality. Quality and prices are guaranteed. We also offer our services in WALL PAPERS, GRACE WALL AND OTHER DECORATIONS in your offices and houses.
            </Typography>
          </Box>
          <CardActionArea className={classes.demo1imgbox}>
            <img src={painterpic1} alt="painterpic1" width="100%" height="100%" style={{borderRadius:"10px"}}/>
          </CardActionArea>
        ...
        <CardActionArea className={classes.demo2imgbox}>
            <img src={painterpic2} alt="painterpic2" width="100%" height="100%" style={{borderRadius:"10px"}}/>
          </CardActionArea>
...
export default Paintersubcategray;
