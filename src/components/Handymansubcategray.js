...
//pictures
import handymanpic1 from "../assets/handymanpic1.png";
import handymanpic2 from "../assets/handymanpic2.jpg";
  ...
  return (
    <>
        ...
        <Box className={classes.topsection}>
          ...
          <Typography variant="h5">We provide Handymans services</Typography>
        ...
        <Box className={classes.demo1}>
          ...
          <CardActionArea className={classes.demo1imgbox}>
            <img src={handymanpic1} alt="handymanpic1" width="100%" height="100%" style={{borderRadius:"10px"}} />
          </CardActionArea>
        ...
        <CardActionArea className={classes.demo2imgbox}>
            <img src={handymanpic2} alt="handymanpic2" width="100%" height="100%" style={{borderRadius:"10px"}} />
          </CardActionArea>
...
export default Handymansubcategray;
