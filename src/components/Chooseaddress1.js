...
import { Typography, Box, Button, TextField,CardActionArea} from "@material-ui/core";
  ...
  return (
    ...
    <Box className={classes.mainsec}>
        ...
        <Box className={classes.loginR}>
          <Typography variant="h6">Choose Your Address1</Typography>
          <Box className={classes.addresshistoryaddnew}>
            <Button className={classes.btn1} onClick={scrolltotop}
             component={Link}
             to="/placeyourorder">
            Address History
            </Button>
            <Button className={classes.btn2}>+ add New</Button>
          </Box>
          ...
          <TextField
            ...
            label=" abc House, 01 street ,phase 5 Hayatabad"
            variant="outlined"
            size="small"
          />
        </Box>
